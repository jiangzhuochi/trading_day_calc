...
def test_get_first_last_day_per_month():
    year2021 = filter_between(start=dt(2021, 4, 1), end=dt(2021, 7, 31))
    ...
    assert [
        ...
        dt(2021, 6, 1),
        dt(2021, 7, 1),
    ] == get_first_day_per_month(year2021)
    ...
    assert [
        ...
        dt(2021, 6, 30),
        dt(2021, 7, 30),
    ] == get_last_day_per_month(year2021)


def test_get_1d_before_or_after_holiday():
    year2021_july = filter_between(start=dt(2021, 7, 1), end=dt(2021, 7, 31))
    year2021_october = filter_between(start=dt(2021, 10, 1), end=dt(2021, 10, 31))
    assert [
        dt(2021, 7, 5),
        dt(2021, 7, 12),
        dt(2021, 7, 19),
        dt(2021, 7, 26),
    ] == get_1d_after_holiday(year2021_july)
    ...
    assert [
        ...
        dt(2021, 7, 23),
        dt(2021, 7, 30),
    ] == get_1d_before_holiday(year2021_july)
    ...
    assert [
        ...
        dt(2021, 10, 18),
        dt(2021, 10, 25),
    ] == get_1d_after_holiday(year2021_october)
    ...
    assert [
        ...
        dt(2021, 10, 22),
        dt(2021, 10, 29),
    ] == get_1d_before_holiday(year2021_october)
